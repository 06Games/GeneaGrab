...
export const fr: RawDictionaries = {
  ...
  infoPanel: {
    ...
    editModal: {
      ...
      titlePlaceholder: "ex : Registre d'état civil de Brignoles",
      subtitlePlaceholder: "ex : Baptêmes, Mariages, Sépultures",
      authorPlaceholder: "ex : Nom du notaire, curé, officier d'état civil",
      ...
      placesLabel: "Lieux",
      placesPlaceholder: "Ajouter un lieu et appuyer sur Entrée…",
      collectionLabel: "Collection",
      collectionPlaceholder: "Ajouter une collection et appuyer sur Entrée…",
      typesLabel: "Types d'actes",
      addType: "Ajouter",
