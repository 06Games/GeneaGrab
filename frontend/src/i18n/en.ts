export const en = {
  ...
  infoPanel: {
    ...
    editModal: {
      ...
      titlePlaceholder: "e.g. Parochial register of Brignoles, Le Petit Marseillais, Bulletin des lois...",
      subtitlePlaceholder: "e.g. Daily regional newspaper, Volume II: Letters C-G...",
      authorPlaceholder: "e.g. Priest, registrar, notary, director name",
      dateFromLabel: "Date from",
      dateFromPlaceholder: "e.g. 1793 or 01/01/1793 or An II",
      dateToLabel: "Date to",
      dateToPlaceholder: "e.g. 1794 or 31/12/1794 or An III",
      placesLabel: "Places",
      placesPlaceholder: "Add place (e.g. France, Var, Brignoles) and press Enter...",
      collectionLabel: "Archival hierarchy / Collection",
      collectionPlaceholder: "e.g. Departmental Archives > Series 1 E > Civil status",
      addLevel: "Add level",
      noCollection: "No archival hierarchy levels added yet.",
      typesLabel: "Record types",
      addType: "Add type",
