...
public class DataAMNice : TheoryData<Data>
{
    public DataAMNice()
    {
        Add(new Data
        {
            URL =
                "https://recherche.archives.nicecotedazur.org/viewer/series/VDN_0029/FRAC006088_002E035_2?img=FRAC006088_002E035_2_030.jpg",
            Id = "FRAC006088_000000029_de-194",
            Page = 30,
            Cote = "2 E 35-2",
            Ville = "Nice",
            DetailPosition = ["France", "Alpes-Maritimes"],
            Types = [RegistryType.Birth],
        ...
        {
            URL =
                "https://recherche.archives.nicecotedazur.org/viewer/series/VDN_0116/FRAC006088_033PER/FRAC006088_033PER_1872_1?img=FRAC006088_033PER_1872_1_0009.jpg",
