...
public class DataAD79_86 : TheoryData<Data>
{
    public DataAD79_86()
    {
        Add(new Data
        {
            URL =
                "https://archives-deux-sevres-vienne.fr/ark:/28387/vtae7b67d081526ee00/daogrp/0/layout:table/idsearch:RECH_67ed934afb0e90890dc0c3d2de28aa19",
            Id = "vtae7b67d081526ee00",
            Page = 1,
            Cote = "collection communale 3171",
            Ville = "Poitiers (Vienne, France)",
            Paroisse = "Sainte-Opportune",
            Types = [RegistryType.Death], // Wrongly typed on the website
        ...
        {
            URL =
                "https://archives-deux-sevres-vienne.fr/ark:/28387/vta653909c68277e7e1/daogrp/0/layout:table/idsearch:RECH_a840bb28ce19d01007ed57125416fdd5",
            ...
            Types =
            [
                RegistryType.BirthTable, RegistryType.MarriageTable, RegistryType.DeathTable
            ], // Wrongly typed on the website
        ...
        {
            URL =
                "https://archives-deux-sevres-vienne.fr/ark:/28387/vtac7d3291f3cb41458/daogrp/0/layout:table/idsearch:RECH_a840bb28ce19d01007ed57125416fdd5",
        ...
        {
            URL =
                "https://archives-deux-sevres-vienne.fr/ark:/28387/vtadc65cbfff41a4055/daogrp/0/layout:table/idsearch:RECH_8dc6362082a86dbcc8a7c360dfc61a3e",
            ...
            Types =
            [
                RegistryType.Birth, RegistryType.Marriage, RegistryType.Death
            ], // Wrongly typed on the website
        ...
        {
            URL =
                "https://archives-deux-sevres-vienne.fr/ark:/58825/vtaf13d60438573a517/daogrp/0/layout:table/idsearch:RECH_8dc6362082a86dbcc8a7c360dfc61a3e",
            Id = "vtaf13d60438573a517",
            Page = 1,
            Cote = "E DEPOT 112 / 2 E 8-1",
            Ville = "Amailloux (Deux-Sèvres, France)",
            Types = [RegistryType.Birth], // Wrongly typed on the website
        ...
        {
            URL =
                "https://archives-deux-sevres-vienne.fr/ark:/28387/vtaf2121e46840a5491/daogrp/0/layout:table/idsearch:RECH_b9fa44b07e9ab743088183667855111a",
        ...
        {
            URL =
                "https://archives-deux-sevres-vienne.fr/ark:/58825/vta2639cbd364735e90/daogrp/0/layout:table/idsearch:RECH_dc2e7b893b169aa88fe2df5be9a123d1",
        ...
        {
            URL =
                "https://archives-deux-sevres-vienne.fr/ark:/58825/vta512b489224012371/daogrp/0/layout:table/idsearch:RECH_a50f70e5d23e0a91af432862af92747d",
