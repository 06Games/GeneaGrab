...
public class DataAD06 : IEnumerable<object[]>
{
    public IEnumerator<object[]> GetEnumerator()
    {
        ...
        yield return new Data
        {
            ...
            Cote = "5 Mi 75/1",
            Details = new []{"Etat civil", "LANTOSQUE"},
            Ville = "Lantosque",
        ...
        yield return new Data
        {
            ...
            Cote = "5 Mi 17/1",
            Details = new []{"Etat civil", "BEZAUDUN-LES-ALPES"},
        ...
        yield return new Data
        {
            ...
            Cote = "2 E 985",
            Details = new []{"Etat civil", "ANTIBES"},
            Ville = "Antibes",
        ...
        yield return new Data
        {
            ...
            Cote = "25 Fi 15/1/A0",
            Details = new[] { "Cadastre. - Plans cadastraux", "BERRE-LES-ALPES" },
        ...
        yield return new Data
        {
            ...
            Cote = "3 P 1503",
            Details = new[] { "Cadastre. - Etats de section", "UTELLE" },
            Ville = "Utelle",
        ...
        yield return new Data
        {
            ...
            Cote = "3 P 1511",
            Details = new[] { "Cadastre. - Matrices", "UTELLE" },
            Ville = "Utelle",
        ...
        yield return new Data
        {
            ...
            Cote = "3 P 828",
            Details = new[] { "Cadastre. - Matrices", "NICE" },
            Ville = "Nice",
        ...
        yield return new Data
        {
            ...
            Cote = "6 M 112",
            Details = new[] { "Recensement de la population BPU3 - (30/11/2021)", "Lantosque" },
            Ville = "Lantosque",
        ...
        yield return new Data
        {
            ...
            Cote = "6 M 149",
            Details = new[] { "Recensement de la population BPU3 - (30/11/2021)", "Nice" },
            Ville = "Nice",
        ...
        yield return new Data
        {
            ...
            Id = "674341.2453955",
            Cote = "3 E 19 83",
            Details = new[] {  "Instrument de recherche des versements d'archives notariales (3 E)", "Versement de l'étude Graillet, à Roquebillière", "Protocoles du notaire Joseph Buffonio, à Lantosque" },
            Ville = "Lantosque",
